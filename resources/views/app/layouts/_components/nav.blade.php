    ...
    <nav class="navbar navbar-expand navbar-light bg-brown ">
        <div class="container-fluid text-white">
            ...
            <div class="col-8">
            <div class="align-items-center m-auto bg-brown">
                <span class="feedback d-none text-center h5 text-white d-flex justify-content-center align-items-center"></span>
            </div>
            </div>
            <div class="col-2">
                <div class="d-flex">
